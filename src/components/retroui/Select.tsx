...
const SelectTrigger = ({
  ...
  return (
    <SelectPrimitive.Trigger
      className={cn(
        "flex  items-center shadow-md justify-between border-2 border-input border-border bg-transparent ring-offset-background placeholder:text-muted-foreground focus:outline-hidden disabled:cursor-not-allowed disabled:opacity-50",
        className,
      )}
      {...props}
    >
